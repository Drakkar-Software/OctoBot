...
2. The Strategy Creator: where you can easily create a new strategy in order to test it in [backtesting](/guides/octobot-usage/backtesting).
...
The [Strategy Designer](/guides/octobot-usage/strategy-designer) is available to [OctoBot trading bots](https://www.octobot.cloud/trading-bot).

**[Start your OctoBot trading bot](https://www.octobot.cloud)**
