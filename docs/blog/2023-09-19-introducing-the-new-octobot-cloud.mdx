...
# Introducing the new OctoBot app
...
The goal of OctoBot has always been to bring automated trading strategies to any crypto investor. This includes tech savvy users as well as all the others. Up until now, OctoBot failed to be usable by any crypto investor and [the new OctoBot app](/) is built for them.
...
2. follow your gains directly from [OctoBot app](/)
...
The current OctoBot (available <a href="https://github.com/Drakkar-Software/OctoBot" rel="nofollow">on github</a>) will stay open source, we will keep updating it as it is the backbone of everything on [OctoBot app](/).
...
At the time of writing, the [new OctoBot app](/) is in beta stage. While the technical part is fully fonctionnal, we are working on the last user interface improvements before completely replacing the [current octobot.cloud](/).

Feel free to use, experiment and give us your feedback on the [new OctoBot app](/), we are looking forward to knowing what your think of it and our new strategy-based plans.
