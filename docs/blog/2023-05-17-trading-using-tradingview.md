...
When using [OctoBot app](/), all you need to do is to [create TradingView alerts](/guides/octobot-interfaces/tradingview#create-an-alert) on any event, directly from Pine Script or from a custom alert.
