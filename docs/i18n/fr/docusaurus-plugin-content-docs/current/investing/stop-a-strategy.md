...
- L'empêcher de créer de nouveaux ordres
- Instantanément vendre toutes les cryptomonnaies achetées par la stratégie (si cette option est sélectionnée)
- Libérer le compte d'échange associé afin de pouvoir l'utiliser avec une autre stratégie
