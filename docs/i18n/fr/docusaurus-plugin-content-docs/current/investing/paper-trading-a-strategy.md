...
![cloud octobot en trading simulé](/images/guides/paper-trading-cloud-octobot.png)

Avec OctoBot, vous pouvez utiliser le trading simulé (ou trading papier) avec n'importe quelle stratégie ou panier de crypto.

Le trading simulé vous permet de tester des stratégies de trading dans des conditions réelles en utilisant un portefeuille virtuel.

C'est parfait pour expérimenter une stratégie de trading ou un panier de crypto sans prendre de risque car seuls des fonds simulés sont utilisés.

## L'utiliser en trading simulé

1. À partir de la stratégie ou le panier de crypto avec lequel vous souhaitez faire du trading simulé, cliquez sur **Démarrer le trading**
2. Sélectionnez **Trading virtuel**
...
3. Sélectionnez le montant que vous souhaitez utiliser dans votre portefeuille simulé
![sélectionner un échange pour une stratégie cloud](/images/guides/trading-virtuel-configuration-du-portefeuille.png)
...
### Votre OctoBot en trading virtuel

Votre OctoBot en mode trading virtuel appliquera maintenant la stratégie ou le panier sélectionné comme s'il était sur un compte d'échange réel, sauf qu'il ne se connectera pas réellement à un compte d'échange.
