...
description: "Apprenez comment créer des profils de configuration personnalisés sur votre OctoBot."
sidebar_position: 5
---
...
## Configuration des évaluateurs et trading
