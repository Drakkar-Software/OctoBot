...
description: "Apprenez comment configurer un profil OctoBot en sélectionnant sa stratégie de trading, ses évaluateurs, les cryptomonnaies, les plateformes d'échange et les paramètres de trading."
sidebar_position: 2
---
...
### Télécharger l'historique des trades
...
- **user/config.json** is the global configuration file, mostly used
  ...
  settings.
- **user/profiles/** contains all the [profiles](/guides/octobot-configuration/profiles)
