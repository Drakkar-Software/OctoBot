---
title: "Créer un tentacle package"
description: "Apprenez à regrouper vos tentacles OctoBot personnalisés dans un package de tentacles, à activer la configuration via les entrées de l'utilisateur, à y ajouter des documents et à le partager."
sidebar_position: 7
---
...
A tentacle package is a python module that contains one or multiple [tentacles](/guides/octobot-tentacles-development/create-a-tentacle)
of the same type.
...
[Tentacle](/guides/octobot-tentacles-development/create-a-tentacle) python modules should be placed at the root path of the
...
Follow the [tentacles installation guide](/guides/octobot-tentacles-development/customize-your-octobot) to install or
