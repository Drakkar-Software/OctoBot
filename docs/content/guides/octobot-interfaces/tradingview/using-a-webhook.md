...
description: "Learn how to configure your OctoBot webhooks to trade from TradingView signals using OctoBot app, Ngrok or your own setup."
sidebar_position: 5
---
...
### Configuration option 1: Using the Premium OctoBot Extension
...
### Configuration option 2: Using Ngrok
