...
description: "Places a fixed amount of buy and sell orders at fixed intervals to profit from any market move. When an order is filled, a mirror order is instantly created..."
keywords: ["trading modes", "strategies", "octobot", "grid-trading-mode"]
slug: /creators/trading-modes/grid-trading-mode
format: md
---
