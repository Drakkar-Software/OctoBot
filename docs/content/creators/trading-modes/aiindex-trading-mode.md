---
title: "AIIndex Trading Mode"
description: "The **AI Index Trading Mode** is an advanced trading mode that inherits from `IndexTradingMode` and uses external AI agents to dynamically generate..."
keywords: ["trading modes", "strategies", "octobot", "aiindex-trading-mode"]
slug: /creators/trading-modes/aiindex-trading-mode
format: md
---
