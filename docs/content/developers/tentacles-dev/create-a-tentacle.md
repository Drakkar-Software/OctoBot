...
A tentacle is part of a [tentacle package](create-a-tentacle-package) 
...
[tentacle package](create-a-tentacle-package)\) and extend the existing 
...
[tentacle package](create-a-tentacle-package) based on 
