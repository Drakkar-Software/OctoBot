...
![paper trading cloud octobot](/images/guides/paper-trading-cloud-octobot.png)
...
3. Select the amount you want to use in your simulated portfolio
![cloud strategy select exchange](/images/guides/paper-trading-virtual-portfolio-configuration.png)
