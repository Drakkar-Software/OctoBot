    ...
    return [
        {
            ...
            backend_enums.OrderKeys.IS_ACTIVE.value: storage_order[trading_constants.STORAGE_ORIGIN_VALUE][
                trading_enums.ExchangeConstantsOrderColumns.IS_ACTIVE.value],
