...
def create_design_strategy_optimizer(
    ...
    return StrategyDesignOptimizer(trading_mode, config, tentacles_setup_config, optimizer_settings)
...
async def generate_and_save_strategy_optimizer_runs(trading_mode, tentacles_setup_config, optimizer_settings) -> list:
    optimizer = StrategyDesignOptimizer(trading_mode, None, tentacles_setup_config, optimizer_settings)
