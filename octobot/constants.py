...
OCTOBOT_COMMUNITY_API_URL = f"{OCTOBOT_COMMUNITY_URL}api/v2/storefront/"
OCTOBOT_COMMUNITY_ACCOUNT_URL = f"{OCTOBOT_COMMUNITY_API_URL}account"
OCTOBOT_COMMUNITY_PACKAGES_URL = f"{OCTOBOT_COMMUNITY_API_URL}tentacle/packages"
OCTOBOT_COMMUNITY_SUPPORTS_URL = f"{OCTOBOT_COMMUNITY_API_URL}supports"
OCTOBOT_COMMUNITY_CONFIGURATION_URL = f"{OCTOBOT_COMMUNITY_API_URL}user_configurations"
