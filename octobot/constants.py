...
FORCE_OCTOBOT_STANDALONE = os_util.parse_boolean_environment_var("FORCE_OCTOBOT_STANDALONE", "False")
...
METRICS_STUCK_NO_EXTERNAL_INTERFACE_DELAY_SECONDS = 3 * 86400
METRICS_CONVERSION_DELAY_SECONDS = 86400
METRICS_GENERIC_EXCHANGE_NAME = "generic"
ENABLE_ACTIVITY_METRICS_DEBUG_LOGS = os_util.parse_boolean_environment_var(
    "ENABLE_ACTIVITY_METRICS_DEBUG_LOGS", "False"
)
METRICS_RECONCILE_RETRY_SECONDS = float(
    os.getenv("METRICS_RECONCILE_RETRY_SECONDS", "30")
)
METRICS_RECONCILE_MAX_RETRY_ATTEMPTS = 20
