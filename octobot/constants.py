...
ENV_TENTACLES_CATEGORY = "TENTACLES_CATEGORY"
...
ENV_TENTACLES_SUBCATEGORY = "TENTACLES_SUBCATEGORY"
...
DEFAULT_TENTACLES_URL = os.getenv(
    ...
    f"{os.getenv(ENV_TENTACLES_CATEGORY, TENTACLE_BASE_CATEGORY)}/"
    f"{os.getenv(ENV_TENTACLES_SUBCATEGORY, '')}"
