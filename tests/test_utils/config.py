...
from config.cst import CONFIG_EVALUATOR, CONFIG_TRADING, CONFIG_TRADING_TENTACLES, TimeFrames, CONFIG_TIME_FRAME
...
def load_test_config():
    ...
    config[CONFIG_TRADING][CONFIG_TRADING_TENTACLES] = load_config("tests/static/trading_config.json", False)
