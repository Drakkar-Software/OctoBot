...
class TwitterNewsEvaluator(NewsSocialEvaluator):
    ...
    def init_api(self):
        self.twitter_api = twitter.Api(self.config["additional_resources"]["twitter"]["api-key"],
                                       self.config["additional_resources"]["twitter"]["api-secret"],
                                       self.config["additional_resources"]["twitter"]["access-token"],
                                       self.config["additional_resources"]["twitter"]["access-token-secret"])
