...
OPEN_ORDER_POLL_INTERVAL = 0.5
OUTDATED_ORDER_PRICE_MAX_THRESHOLD = 0.03 # 3%
...
DEFAULT_MIRRORED_ORDER_QUANTITY_RATIO_THRESHOLD = decimal.Decimal("0.02") # 2%
DEFAULT_MIRRORED_ORDER_PRICE_RATIO_THRESHOLD = decimal.Decimal("0.0001") # 0.01%
