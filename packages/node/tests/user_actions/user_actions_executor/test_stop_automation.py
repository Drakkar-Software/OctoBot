...
import octobot_node.user_actions.user_actions_executor.stop_automation as stop_automation_executor
...
class TestResolveActiveAutomationWorkflowIdsForParentId:
    ...
    async def test_delegates_to_get_parent_and_children_workflow_ids(self):
        with mock.patch.object(
            ...
            "_get_parent_and_children_workflow_ids",
...
class TestStopAutomationActionExecutor:
    ...
    async def test_execute_sends_stop_via_send_async_when_workflow_ids_match(self):
        ...
        with (
            mock.patch("octobot_node.user_actions.user_actions_executor.stop_automation.scheduler_module.is_initialized", return_value=True),
