...
import octobot_node.scheduler.user_actions.user_actions_executor.account.delete_account as delete_account_executor
...
class TestDeleteAccountActionExecutorExecute:
    ...
    async def test_calls_provider_delete_with_wallet_and_id(self):
        ...
        assert record_account_deleted_mock.call_args.kwargs["account_count"] == 0
