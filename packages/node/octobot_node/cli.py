...
def start_server(args):
    ...
    from octobot_tentacles_manager.api.inspector import get_tentacle_class_from_string
    
    node_api_interface = get_tentacle_class_from_string("NodeApiInterface")
    uvicorn.run(
        node_api_interface.create_app(),
        host=host,
        port=port,
        log_level="info",
