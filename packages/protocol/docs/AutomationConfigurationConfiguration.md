# AutomationConfigurationConfiguration
...
json = "{}"
# create an instance of AutomationConfigurationConfiguration from a JSON string
automation_configuration_configuration_instance = AutomationConfigurationConfiguration.from_json(json)
# print the JSON string representation of the object
print(AutomationConfigurationConfiguration.to_json())

# convert the object into a dict
automation_configuration_configuration_dict = automation_configuration_configuration_instance.to_dict()
# create an instance of AutomationConfigurationConfiguration from a dict
automation_configuration_configuration_from_dict = AutomationConfigurationConfiguration.from_dict(automation_configuration_configuration_dict)
```
