...
class TestMarketMakingSymbolConfiguration(unittest.TestCase):
    """MarketMakingSymbolConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketMakingSymbolConfiguration:
        """Test MarketMakingSymbolConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketMakingSymbolConfiguration`
        """
    ...
    def testMarketMakingSymbolConfiguration(self):
        """Test MarketMakingSymbolConfiguration"""
