...
class TestAccountTradingWithAccountId(unittest.TestCase):
    """AccountTradingWithAccountId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountTradingWithAccountId:
        """Test AccountTradingWithAccountId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountTradingWithAccountId`
        """
        model = AccountTradingWithAccountId()
        if include_optional:
            return AccountTradingWithAccountId(
                account_id = '',
    ...
    def testAccountTradingWithAccountId(self):
        """Test AccountTradingWithAccountId"""
