...
class TestCopiedAccount(unittest.TestCase):
    """CopiedAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CopiedAccount:
        """Test CopiedAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CopiedAccount`
        """
        model = CopiedAccount()
        if include_optional:
            return CopiedAccount(
                ...
                updated_at = 1.337,
                copied_assets = [
                    octobot_protocol.models.copied_asset.CopiedAsset(
                        name = '', 
                        total = 1.337, 
                        available = 1.337, 
                        ratio = 1.337, )
                ...
                historical_snapshots = [
                    octobot_protocol.models.copied_account.CopiedAccount(
                        version = '', 
                        updated_at = 1.337, 
                        copied_assets = [
                            octobot_protocol.models.copied_asset.CopiedAsset(
