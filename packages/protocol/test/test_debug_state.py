...
class TestDebugState(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DebugState:
        """Test DebugState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebugState`
        """
        model = DebugState()
        if include_optional:
            return DebugState(
                version = '',
                debug = octobot_protocol.models.debug.Debug(
                    automations = [
