...
class Position(BaseModel):
    ...
    entry_price: Union[StrictFloat, StrictInt]
    mark_price: Union[StrictFloat, StrictInt]
    liquidation_price: Union[StrictFloat, StrictInt]
    status: PositionStatus
    __properties: ClassVar[List[str]] = ["id", "symbol", "side", "quantity", "entry_price", "mark_price", "liquidation_price", "status"]
