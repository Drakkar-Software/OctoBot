...
class EditExchangeConfigConfiguration(BaseModel):
    """
    EditExchangeConfigConfiguration
    """ # noqa: E501
    action_type: UserActionType = Field(description="exchange_config_edit")
    id: StrictStr
    configuration: Optional[ExchangeConfig] = None
    __properties: ClassVar[List[str]] = ["action_type", "id", "configuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "configuration": ExchangeConfig.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
