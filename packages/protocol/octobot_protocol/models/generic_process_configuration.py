...
class GenericProcessConfiguration(BaseModel):
    """
    ...
    def configuration_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['GenericProcessConfiguration']):
            raise ValueError("must be one of enum values ('GenericProcessConfiguration')")
        return value
