...
class ActiveOrderSwapStrategy(BaseModel):
    """
    ActiveOrderSwapStrategy
    """ # noqa: E501
    type: ActiveOrderSwapStrategyType
    trigger_price_configuration: Optional[Dict[str, Any]] = None
    timeout: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["type", "trigger_price_configuration", "timeout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "trigger_price_configuration": obj.get("trigger_price_configuration"),
