...
class SignalPriorityActionExecutionResult(BaseModel):
    """
    SignalPriorityActionExecutionResult
    """ # noqa: E501
    priority_action_id: StrictStr
    error_status: Optional[StrictStr] = None
    error_message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["priority_action_id", "error_status", "error_message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "priority_action_id": obj.get("priority_action_id"),
