...
class ResetAccountTradingDataConfiguration(BaseModel):
    """
    ResetAccountTradingDataConfiguration
    """ # noqa: E501
    action_type: UserActionType = Field(description="reset_account_trading_data")
    account_ids: Annotated[List[StrictStr], Field(min_length=1)]
