...
class DslKeyword(BaseModel):
    """
    Definition of one DSL keyword (signature and configuration).
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Stable DSL keyword id.")
    category: DslKeywordCategory
    label: StrictStr
    description: StrictStr
    inputs: List[DslParameter]
    outputs: List[DslParameter]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "category", "label", "description", "inputs", "outputs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputs": [DslParameter.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None,
            "outputs": [DslParameter.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None
        })
