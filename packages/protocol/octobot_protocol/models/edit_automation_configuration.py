...
class EditAutomationConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "action_type", "configuration"]

    @field_validator('action_type')
    def action_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['automation_edit']):
            raise ValueError("must be one of enum values ('automation_edit')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configuration": AutomationConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
