...
class EditStrategyConfiguration(BaseModel):
    """
    EditStrategyConfiguration
    """ # noqa: E501
    action_type: UserActionType = Field(description="strategy_edit")
    id: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "configuration": Strategy.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
