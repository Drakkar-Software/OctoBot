...
async def test_exchange_actions_reset_executing_market_order_twice(
    ...
    with (
        ...
        async with octobot_flow.jobs.AutomationJob(post_first_buy_state, [], [], auth_details) as automations_job_2:
...
resolved_actions(actions_to_execute),
        ...
        async with octobot_flow.jobs.AutomationJob(automation_state_2, [], [], auth_details) as automations_job_2:
            await automations_job_2.run()
        ...
        async with octobot_flow.jobs.AutomationJob(limit_order_state_3, [], [], auth_details) as automations_job_3:
        ...
        async with octobot_flow.jobs.AutomationJob(automation_state_4, [], [], auth_details) as automations_job_4:
