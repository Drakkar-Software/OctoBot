...
from typing import Union, List, Set, Optional, Dict, ClassVar, Any
from typing_extensions import Literal, Self


class UserActionResultType(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserActionResultType from a JSON string"""
...
class AccountActionResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["updated_at", "error_details", "result_type"]
...
class AutomationActionResult(BaseModel):
    ...
    result_type: UserActionResultType
    __properties: ClassVar[List[str]] = ["updated_at", "error_details", "created_automation_id", "result_type"]
