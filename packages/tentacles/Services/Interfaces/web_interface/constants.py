...
# uvicorn / web interface server lifecycle
UVICORN_GRACEFUL_SHUTDOWN_SECONDS = 3
UVICORN_TIMEOUT_KEEP_ALIVE_SECONDS = 5
WEB_INTERFACE_STOP_WAIT_SECONDS = UVICORN_GRACEFUL_SHUTDOWN_SECONDS + 1
WEB_INTERFACE_STOP_FORCE_EXIT_WAIT_SECONDS = UVICORN_GRACEFUL_SHUTDOWN_SECONDS
