...
export const BotAvatar = memo(function BotAvatar({ isRunning }: { isRunning: boolean }) {
  ...
  return (
    <div className="relative flex size-12 shrink-0 items-center justify-center">
      {isRunning && (
        <>
          <svg className="absolute inset-0 size-full" viewBox="0 0 48 48" aria-hidden>
            <circle cx="24" cy="24" r={RING_RADIUS} fill="none" className="stroke-muted-foreground/20" strokeWidth="2" />
          </svg>
          <svg
