...
export const GENERAL_EXPORT_TEMPLATE: ExportTemplate = {
  ...
  columns: [
    ...
    },
    {
      key: "status",
      label: "Status",
      jsonPath: "__task_status__",
      formatter: "text",
    },
    {
      key: "exec_type",
      label: "Execution Type",
      jsonPath: "__exec_type__",
      formatter: "text",
    },
    {
      key: "completed_at",
...
export const TRADE_EXPORT_TEMPLATE: ExportTemplate = {
  ...
  columns: [
    ...
    },
    {
      key: "timestamp",
      label: "Timestamp",
      jsonPath: `${TRADE_STATE_PREFIX}.timestamp`,
      formatter: "date",
    },
    {
      key: "symbol",
      label: "Symbol",
      jsonPath: `${TRADE_STATE_PREFIX}.symbol`,
      formatter: "text",
    },
    {
      key: "type",
      label: "Type",
      jsonPath: `${TRADE_STATE_PREFIX}.type`,
      formatter: "text",
    },
    {
      key: "side",
      label: "Side",
      jsonPath: `${TRADE_STATE_PREFIX}.side`,
      formatter: "text",
    },
    {
      key: "amount",
      label: "Amount",
      jsonPath: `${TRADE_STATE_PREFIX}.amount`,
      formatter: "number",
    },
    {
      key: "price",
      label: "Price",
      jsonPath: `${TRADE_STATE_PREFIX}.price`,
      formatter: "number",
    },
    {
      key: "cost",
      label: "Cost",
      jsonPath: `${TRADE_STATE_PREFIX}.cost`,
      formatter: "number",
    },
    {
      key: "creation_time",
      label: "Creation Time",
      jsonPath: `${TRADE_STATE_PREFIX}.creation_time`,
      formatter: "date",
    },
    {
      key: "entries",
      label: "Entries",
      jsonPath: `${TRADE_STATE_PREFIX}.entries`,
      formatter: "json",
    },
    {
      key: "exchange_id",
      label: "Exchange ID",
      jsonPath: `${TRADE_STATE_PREFIX}.exchange_id`,
      formatter: "text",
    },
    {
      key: "exchange_trade_id",
      label: "Exchange Trade ID",
      jsonPath: `${TRADE_STATE_PREFIX}.exchange_trade_id`,
      formatter: "text",
    },
    {
      key: "fee_cost",
      label: "Fee Cost",
      jsonPath: `${TRADE_STATE_PREFIX}.fee.cost`,
      formatter: "number",
    },
    {
      key: "fee_currency",
      label: "Fee Currency",
      jsonPath: `${TRADE_STATE_PREFIX}.fee.currency`,
      formatter: "text",
    },
    {
      key: "quantity_currency",
      label: "Quantity Currency",
      jsonPath: `${TRADE_STATE_PREFIX}.quantity_currency`,
      formatter: "text",
    },
    {
      key: "reduce_only",
      label: "Reduce Only",
      jsonPath: `${TRADE_STATE_PREFIX}.reduceOnly`,
      formatter: "text",
    },
    {
      key: "trade_status",
      label: "Trade Status",
      jsonPath: `${TRADE_STATE_PREFIX}.status`,
      formatter: "text",
    },
    {
      key: "tag",
      label: "Tag",
      jsonPath: `${TRADE_STATE_PREFIX}.tag`,
      formatter: "text",
    },
  ],
}

const AUTOMATION_STATE_PREFIX =
  "state.automation.exchange_account_elements.transactions[0]"
...
export const TRANSFER_EXPORT_TEMPLATE: ExportTemplate = {
  ...
  columns: [
    ...
    },
    {
      key: "address_from",
      label: "From Address",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.address_from`,
      formatter: "text",
    },
    {
      key: "address_to",
      label: "To Address",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.address_to`,
      formatter: "text",
    },
    {
      key: "amount",
      label: "Amount",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.amount`,
      formatter: "number",
    },
    {
      key: "currency",
      label: "Currency",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.currency`,
      formatter: "text",
    },
    {
      key: "txid",
      label: "TX Id",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.txid`,
      formatter: "text",
    },
    {
      key: "fee_cost",
      label: "Fee Cost",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.fee.cost`,
      formatter: "number",
    },
    {
      key: "fee_currency",
      label: "Fee Currency",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.fee.currency`,
      formatter: "text",
    },
    {
      key: "timestamp",
      label: "Time",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.timestamp`,
      formatter: "date",
    },
    {
      key: "network",
      label: "Network",
      jsonPath: `${AUTOMATION_STATE_PREFIX}.network`,
      formatter: "text",
    },
  ],
}
