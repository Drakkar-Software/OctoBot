...
Example:
{"message": "Bearish argument...", "reasoning": "Brief rationale."}"""
...
Your bearish argument (short, one paragraph):"""
    ...
    async def execute(self, input_data: typing.Any, ai_service) -> typing.Any:
        ...
        if not out.message:
            self.logger.warning("Bear research agent returned empty message; using fallback.")
            out.message = "No bearish argument generated by the LLM."
