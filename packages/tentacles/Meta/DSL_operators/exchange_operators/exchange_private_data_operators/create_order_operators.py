...
class _OrderFactory:
    ...
    def _get_validated_amount_and_price(
    ...
    async def _create_stop_orders(
        ...
        base_order: octobot_trading.personal_data.Order, symbol_market: dict,
        ...
        adapted_stop_price = octobot_trading.personal_data.decimal_adapt_price(
        ...
        param_update, chained_order = await octobot_trading.personal_data.create_and_register_chained_order_on_base_order(
            base_order, adapted_stop_price, octobot_trading.enums.TraderOrderType.STOP_LOSS, exit_side,
    ...
    def _create_active_order_swap_strategy(self, kwargs: dict) -> octobot_trading.personal_data.ActiveOrderSwapStrategy:
        ...
        return octobot_trading.personal_data.create_active_order_swap_strategy(
            strategy_type, **kwargs.get("active_order_swap_strategy_params", {})
        )

    async def _create_base_order_associated_elements(
        self, base_order: octobot_trading.personal_data.Order, ctx: script_keywords.Context, symbol_market: dict, kwargs: dict
    ) -> None:
        # create chained orders
        params = {}
        chained_orders = []
        await self._create_stop_orders(ctx, base_order, symbol_market, params, chained_orders, kwargs)
        ...
        if stop_orders and tp_orders:
            ...
            elif trailing_profile_type == octobot_trading.personal_data.TrailingProfileTypes.FILLED_TAKE_PROFIT.value:
    ...
    async def create_base_order_and_associated_elements(self, **kwargs: typing.Any) -> octobot_trading.personal_data.Order:
        ...
        try:
            ...
            valid_amount, valid_price = self._get_validated_amount_and_price(
            ...
            await self._create_base_order_associated_elements(base_order, ctx, symbol_market, kwargs)
            return base_order
...
class CreateOrderOperator(exchange_operator.ExchangeOperator):
    ...
    async def pre_compute(self) -> None:
        ...
        order = await order_factory.create_base_order_and_associated_elements(**self.param_by_name)
        ...
        self.value = created_order.to_dict()
