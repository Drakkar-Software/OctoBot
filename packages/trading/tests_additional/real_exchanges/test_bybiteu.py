...
class TestBybitEuRealExchangeTester(real_exchange_tester.RealExchangeTester):
    ...
    async def test_active_symbols(self):
        await self.inner_test_active_symbols(120, 120)

    async def test_get_market_status(self):
        await self.assert_get_market_status(
            has_price_limits=False,
            expected_symbols=[self.SYMBOL, self.SYMBOL_2],
        )
