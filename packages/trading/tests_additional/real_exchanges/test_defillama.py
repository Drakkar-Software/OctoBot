...
class TestDefillamaRealExchangeTester(real_exchange_tester.RealExchangeTester):
    EXCHANGE_NAME = "defillama"
    SYMBOL = f"{WETH_ADDRESS}/{USDC_ADDRESS}{NO_DEX_SYMBOL_SUFFIX}"
    SYMBOL_2 = f"{WETH_ADDRESS}/{USDT_ADDRESS}{ANY_DEX_SYMBOL_SUFFIX}"
    SYMBOL_3 = f"{WETH_ADDRESS}/{USDT_ADDRESS}{ANY_DEX_SYMBOL_SUFFIX}"
    SYMBOL_4 = f"{UNI_ADDRESS}/{USDC_ADDRESS}{ANY_DEX_SYMBOL_SUFFIX}"
    SYMBOL_5 = f"{UNI_ADDRESS}/{WETH_ADDRESS}{ANY_DEX_SYMBOL_SUFFIX}"
    SYMBOL_6 = f"{WETH_BASE_ADDRESS}/{USDC_BASE_ADDRESS}{ANY_DEX_SYMBOL_SUFFIX_2}" # on base
    USES_TENTACLE = False
    ...
    async def test_get_all_currencies_price_ticker(self):
        ...
        await self.assert_get_all_currencies_price_ticker(
            symbols=[self.SYMBOL, self.SYMBOL_2, self.SYMBOL_4, self.SYMBOL_5, self.SYMBOL_6],
            extra_checks=extra_checks,
