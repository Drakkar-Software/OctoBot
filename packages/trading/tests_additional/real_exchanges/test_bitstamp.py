...
class TestBitstampRealExchangeTester(real_exchange_tester.RealExchangeTester):
    ...
    async def test_get_order_book(self):
        # Bitstamp returns a very deep book by default (no limit in this test).
        await self.assert_get_order_book(
            limit=None,
            depth_mode="minimum",
            min_orders_per_side=1000,
        )
