...
TENTACLES_AGENTS_SUBAGENTS_PATH = "sub_agents"
...
TENTACLES_TRADING_BLOCKCHAIN_WALLET_PATH = "Blockchain_wallet"
TENTACLES_TRADING_LENDING_PROTOCOL_PATH = "Lending_protocol"
...
TENTACLES_FOLDERS_ARCH = {
    TENTACLES_AGENTS_PATH: [
        TENTACLES_AGENTS_SUBAGENTS_PATH,
    ...
    TENTACLES_TRADING_PATH: [
        ...
        TENTACLES_TRADING_BLOCKCHAIN_WALLET_PATH,
        TENTACLES_TRADING_LENDING_PROTOCOL_PATH
    ]
}
